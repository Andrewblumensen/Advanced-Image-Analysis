...
#%% QUESTION 1
I_noisy = skimage.io.imread('C:/Users/hujo8/OneDrive/Advanced image analysis/1 Week/noisy_number.png').astype(np.float)
sigma = 15;
...
for i in range(3):
    ...
    I = skimage.io.imread('C:/Users/hujo8/OneDrive/Advanced image analysis/1 Week/fuel_cells/' + name)
    L = boundary_length(I)
    ax[i].imshow(I)
    ax[i].set_title(f'{name}\nL = {L}')

#%% QUESTION 3
X_noisy = np.loadtxt('C:/Users/hujo8/OneDrive/Advanced image analysis/1 Week/curves/' + 'dino_noisy.txt')
N = X_noisy.shape[0]
