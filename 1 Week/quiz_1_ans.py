# -*- coding: utf-8 -*-
"""
Created on Wed Feb  9 14:00:33 2022
...
#%% QUESTION 1
I_noisy = skimage.io.imread('noisy_number.png').astype(np.float)
sigma = 15;
...
for i in range(3):
    ...
    I = skimage.io.imread('fuel_cells/' + name)
    L = boundary_length(I)
    ax[i].imshow(I)
    ax[i].set_title(f'{name}\nL = {L}')

#%% QUESTION 3
X_noisy = np.loadtxt('curves/' + 'dino_noisy.txt')
N = X_noisy.shape[0]
